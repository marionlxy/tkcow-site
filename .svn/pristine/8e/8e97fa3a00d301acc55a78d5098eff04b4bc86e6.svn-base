...
<div class="easyui-panel" title="XX信息管理" style="width:805px">
	<div style="padding: 10px 60px 20px 60px">
		<form id="dataForm" method="post">
				<div class="fitem">
		        	<label>claimid:</label>
		        	<input name="claimid" class="easyui-textbox" >
		    	</div>
				<div class="fitem">
				...
				<div class="fitem">
		        	<label>meansNum:</label>
		        	<input name="meansNum" class="easyui-textbox" >
		    	</div>
					</form>
...
<script type="text/javascript">
	...
	jQuery(function(){	  
   	...
   	$('#dataTable').datagrid({
		...
		columns:[[
							{field:'claimid',title:'claimid',width:80},
							...
							{field:'meansNum',title:'meansNum',width:80},
						//注：最后一行后面的逗号要去掉
		]],
		toolbar : [{
			id : 'btnadd',

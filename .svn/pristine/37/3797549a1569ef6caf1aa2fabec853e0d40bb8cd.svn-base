...
<body>
	<div class="second_body">
		...
		<div class="title-zh">泰康人寿 IKFA DEMO</div>
		<div class="title-en">TaiKang Life Insurance FrontEnd Claim
			System</div>
			...
			<table border="0" style="width: 300px;">
				<tr>
					...
					<td colspan="2"><input class="login easyui-textbox"
						name="usernamepro" value="sysadmin" id="usernamepro"
				...
				<tr>
					<td></td>
						<td colspan="2"><input type="checkbox" id="remember" /><span>系统记住我</span>

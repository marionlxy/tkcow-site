...
public class DictEntryController extends BaseController {
	...
	@ResponseBody
	public Map<String, Object> getDictEntryList(HttpServletRequest request,
	        CurrentPage page) {
	...
	public String showDictEntryEditPage(String dictTypeId, String dictId,
	        Model model) {
	...
	@ResponseBody
	public Dto getDictEntryById(@RequestParam("dictTypeId") String dictTypeId,

...
public class UserController  extends BaseController  {
	...
	*/
	...
	public String showConfig(
	        @RequestParam("columnStr") String columnStr, Model model) {
	...
	private void exportExcel(HttpServletRequest request, HttpServletResponse response, @RequestParam("usercode") String userCode,
	        @RequestParam("username") String userName) {
		Dto param = getParamAsDto(request);
	...
	private void exportExcelByTemplate(HttpServletRequest request,
			HttpServletResponse response, @RequestParam("rowId") String rowId) {

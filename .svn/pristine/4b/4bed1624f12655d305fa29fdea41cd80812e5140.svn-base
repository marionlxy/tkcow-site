...
public class MenuController  extends BaseController  {
	...
	public String showEditButtonPage(@RequestParam("menuId") String menuId,
	        Model model) {
	...
	public List<MenuTree> getMenuTree(@RequestParam("id") String menuId,
		...
		if (menuId != null) {
			return menuAction.getMenuTree(menuId, "open", menuId,
			        "icon-text_list_numbers", "icon-page_forward");
		} else {
	...
	@ResponseBody
	public Map<String, Object> getMenuList4Tree(HttpServletRequest request,
	        CurrentPage page) {
		Map<String, Object> map = new HashMap<String, Object>();
	...
	@ResponseBody
	public Map<String, Object> getBtnList(
	        @RequestParam("menuId") String menuId, HttpServletRequest request,
	        CurrentPage page) {
		Map<String, Object> map = new HashMap<String, Object>();
	...
	@ResponseBody
	private Map<String, String> saveButtons(@RequestBody Map buttonMaps,
	        HttpServletRequest request) {
		Map<String, String> map = new HashMap<String, String>();
		LoginUser user = UserUtils.getUser();
		String loginId = String.valueOf(1);

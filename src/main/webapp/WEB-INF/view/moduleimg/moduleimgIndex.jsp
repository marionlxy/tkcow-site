...
<div class="easyui-panel" title="XX信息管理" style="width:805px">
	<div style="padding: 10px 60px 20px 60px">
		<form id="dataForm" method="post">
				...
				<div class="fitem">
		        	<label>modImgDes:</label>
		        	<input name="modImgDes" class="easyui-textbox" >
		    	</div>
				<div class="fitem">
		        	<label>modImgOutside:</label>
		        	<input name="modImgOutside" class="easyui-textbox" >
		    	</div>
				<div class="fitem">
	...
	jQuery(function(){	  
   	...
   	$('#dataTable').datagrid({
		...
		columns:[[
							...
							{field:'modImgDes',title:'modImgDes',width:80},
							{field:'modImgOutside',title:'modImgOutside',width:80},

	...
	<div style="padding: 10px 60px 20px 60px">
		<form id="dataForm" method="post">
				<div class="fitem">
		        	...
		        	<input name="banImgId" class="easyui-textbox" >
		    	</div>
				<div class="fitem">
		        	<label>banId:</label>
		        	<input name="banId" class="easyui-textbox" >
		    	</div>
				<div class="fitem">
				...
				<div class="fitem">
		        	...
		        	<input name="banImgName" class="easyui-textbox" >
		    	</div>
				<div class="fitem">
		        	<label>banImgUrl:</label>
		        	<input name="banImgUrl" class="easyui-textbox" >
		    	</div>
				<div class="fitem">
		        	<label>banImgDes:</label>
		        	<input name="banImgDes" class="easyui-textbox" >
		    	</div>
				<div class="fitem">
		        	<label>banImgOutside:</label>
		        	<input name="banImgOutside" class="easyui-textbox" >
		    	</div>
				<div class="fitem">
		        	<label>banImgNum:</label>
		        	<input name="banImgNum" class="easyui-textbox" >
		    	</div>
				<div class="fitem">
		        	<label>banImgRename:</label>
		        	<input name="banImgRename" class="easyui-textbox" >
		    	</div>
				<div class="fitem">
...
<script type="text/javascript">
	...
	jQuery(function(){	  
   	...
   	$('#dataTable').datagrid({
		...
		columns:[[
							{field:'banImgId',title:'banImgId',width:80},
							{field:'banId',title:'banId',width:80},
							{field:'belongId',title:'belongId',width:80},
							{field:'banType',title:'banType',width:80},
							{field:'banImgName',title:'banImgName',width:80},
							{field:'banImgUrl',title:'banImgUrl',width:80},
							{field:'banImgDes',title:'banImgDes',width:80},
							{field:'banImgOutside',title:'banImgOutside',width:80},
							{field:'banImgNum',title:'banImgNum',width:80},
							{field:'banImgRename',title:'banImgRename',width:80},
   ...
   function editrow(){    	
       ...
       if (row){
       	url = '${rootPath}/banner/edit?rowId='+ row.rowId;
		openWin(url);
       }
       else
       {
   ...
   function delerow(){
       ...
       if (row){
           $.messager.confirm('提示','确定要删除行记录吗？',function(r){
               if (r){
                   $.post('${rootPath}/banner/del',{rowId:row.rowId},function(data){

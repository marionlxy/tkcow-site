...
<div class="easyui-panel" title="XX信息管理" style="width:805px">
	<div style="padding: 10px 60px 20px 60px">
		<form id="dataForm" method="post">
				...
				<div class="fitem">
		        	<label>modType:</label>
		        	<input name="modType" class="easyui-textbox" >
		    	</div>
				<div class="fitem">
		        	<label>modName:</label>
				...
				<div class="fitem">
		        	<label>modKeyWorld:</label>
		        	<input name="modKeyWorld" class="easyui-textbox" >
		    	</div>
				<div class="fitem">
		        	<label>modSeo:</label>
				...
				<div class="fitem">
		        	<label>seoDes:</label>
		        	<input name="seoDes" class="easyui-textbox" >
		    	</div>
				<div class="fitem">
		        	<label>title:</label>
	...
	jQuery(function(){	  
   	...
   	$('#dataTable').datagrid({
		...
		columns:[[
							...
							{field:'modType',title:'modType',width:80},
							{field:'modName',title:'modName',width:80},
							{field:'modByname',title:'modByname',width:80},
							{field:'modKeyWorld',title:'modKeyWorld',width:80},
							{field:'modSeo',title:'modSeo',width:80},
							{field:'seoDes',title:'seoDes',width:80},

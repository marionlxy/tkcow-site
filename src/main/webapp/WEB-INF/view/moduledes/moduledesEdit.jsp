...
<div class="easyui-panel" title="XX详细信息编辑" style="width:600px">
	<form id="dataForm">
			...
			<div class="fitem">
		    	<label>modType:</label>
		        <input name="modType" class="easyui-textbox" data-options="required:true">
			</div>
			<div class="fitem">
		    	<label>modName:</label>
			...
			<div class="fitem">
		        ...
		        <input name="modKeyWorld" class="easyui-textbox" data-options="required:true">
			</div>
			<div class="fitem">
		    	<label>modSeo:</label>
			...
			<div class="fitem">
		    	<label>seoDes:</label>
		        <input name="seoDes" class="easyui-textbox" data-options="required:true">
			</div>
			<div class="fitem">
		    	<label>title:</label>

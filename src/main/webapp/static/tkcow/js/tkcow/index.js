			...
			if(spicObj.length%3!=0){
				...
				rows=spicObj.length/3;
				 ...
				 for(var i=0;i<spicObj.length;i++){
					       var imgpath = path +'/' + spicObj[i].Bico;
					 		if(i<3){
							 $("#homeModel").append('<dl>'
						              +'<dd><a href="'+path+'/'+spicObj[i].AmodUrl+'">'+spicObj[i].AmodName+'</a></dd>'
						              +'<dt> <div class="sypic">'
						              +'<a href="'+path+'/'+spicObj[i].AmodUrl+'">'
						              +'<img src="'+path+'/'+spicObj[i].Bimg+'" width="306" height="210" original="'+spicObj[i].Bimg+'" style="display: block;">'
						              +'<div class="pic"><img src="'+imgpath+'" width="20" height="19" original="img/pic1.png" style="display: block;"></div>'

package com.taikang.tkcow.banner.service.impl;
 ...
 implements IBannerService<BannerBO>  
  {
	...
	/**
     * 查询首页banner列表 ，重新组装为map
     */
	public List<Dto> findAllMapHomeBanner(Dto param){
		logger.debug("<======BannerServiceImpl--	findAllMapHomeBanner======>");		
		return appDao.queryForMapList("Banner.findAllMapHomeBanner", param);
	}
 }

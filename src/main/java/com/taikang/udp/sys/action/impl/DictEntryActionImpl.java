...
public class DictEntryActionImpl extends BaseActionImpl 
  implements IDictEntryAction {
	...
	public List<Dto> findAll(Dto param) {
		...
		List<Dto> result = dictEntryService.findAllMap(param);

		Collections.sort(result, new Comparator<Dto>() {
			@Override
			public int compare(Dto o1, Dto o2) {
				if (o1.getAsInteger("Sort_No") != null && o2.getAsInteger("Sort_No") != null) {
					return o1.getAsInteger("Sort_No").compareTo(o2.getAsInteger("Sort_No"));
				} else {
					return 0;
				}

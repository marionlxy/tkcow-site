...
public class RoleMenuController  extends BaseController  {
	...
	@ResponseBody
	public Map<String, Object> getRoleMenuList(HttpServletRequest request,
	        CurrentPage page) {
	...
	@ResponseBody
	private Map<String, String> saveRoleMenu(HttpServletRequest request,
	...
	*/
	...
	@ResponseBody
	public Map<String, String> deleteRoleMenu(
